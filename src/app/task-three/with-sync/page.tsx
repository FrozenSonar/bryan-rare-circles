...
import { useScreenMd } from "~/hooks/use-screen";
import CardComponent from "../_components/card-component";
import TaskContainer from "~/app/_components/task-container";
 ...
 *  - Error states when data is not supplied properly or hydration fails
 */
export default function TaskThreeWithSync() {
		...
		<TaskContainer>
			<div className="flex flex-col justify-center items-center gap-8">
				...
				<div className="flex flex-col items-center gap-16">
					<CardComponent isMobile={!md} text="With useSyncExternalStore" />
				</div>
			</div>
		</TaskContainer>
	);
	...
	return (
		<div className="flex flex-col gap-8 text-center">
			...
			<h2 className="text-xl font-bold tracking-tight md:text-[1.5rem]">
				Reload your browser{" "}
				<span className="text-[hsl(234,55%,70%)]">quickly </span> to see no
				errors
			</h2>
		</div>
	);
